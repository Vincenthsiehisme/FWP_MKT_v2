    ...
    <div className="w-full max-w-5xl mx-auto animate-fade-in-up pb-12">
      ...
      <div ref={scrollRef}>
        {!record.shippingDetails ? (
            ...
            <div 
               ref={successRef}
               className="bg-slate-800/40 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-xl relative overflow-hidden animate-fade-in-up"
            >
                {/* Success Section - 保持完全不變 */}
